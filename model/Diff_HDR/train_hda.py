...
if __name__ == "__main__":
    ...
    parser.add_argument('-c', '--config', type=str, default='config/Diff_LDR.json',
            ...
            for _, train_data in enumerate(train_loader):
                ...
                if current_step % opt['train']['val_freq'] == 0:
                    ...
                    for _,  val_data in enumerate(val_loader):
                        ...
                        #Metrics.save_img(
                        #    x0_denoise_img, '{}/{}_{}_x0_denoise.png'.format(result_path, current_step, idx))
                        """tb_logger.add_image(
                            'Iter_{}'.format(current_step),
                            np.transpose(np.concatenate(
                                (fake_img, low_img, high_img), axis=1), [2, 0, 1]), idx)"""
